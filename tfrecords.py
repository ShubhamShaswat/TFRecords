...
def process_and_save():    
 ...
 """
 If you want to create a tfrecord from Celeba Dataset and then call the 
	functions below.The reason to process and save the image separately is t
	o avoid creating a large tfrecord file.I couldn't find the way to create 
	tfrecord and process the data simultaneously without creating a large 
	tfrecord file
"""
